...
### Documentation
- **changelog**: add [Unreleased] section and fix version links 🔧
- add comprehensive CHANGELOG documenting versions 0.1.0-0.1.6 📝
...
[Unreleased]: https://github.com/tizee/tmux-capture/compare/v0.1.6...HEAD
...
[0.1.1]: https://github.com/tizee/tmux-capture/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/tizee/tmux-capture/releases/tag/v0.1.0
